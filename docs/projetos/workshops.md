...
Here are the references of my previous workshop presentations.

---

## 2025

### Introduction to empirical studies with legal dataset
**Workshop of empirical analysis of legal dataset** · Insper, São Paulo  
*August - November 2025* · 

Workshop de análise empírica utilizando dados do Direito, apresentado no Insper no segundo semestre de 2025.

**Tópicos abordados:**

- Noções básicas de Python
- Como coletar e extrair informações de dados de texto
- Principais estratégias empíricas de causalidade
- Regressões estatísticas utilizando Python

[Como abrir e sanitizar uma base de dados](../assets/workshops/empirical_legal/aula_base_dados1.ipynb)
